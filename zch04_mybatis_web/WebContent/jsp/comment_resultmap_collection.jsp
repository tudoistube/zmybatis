...
CommentReplies comment = commentService.selectCommentByPrimaryKeyCollection(commentNo);
%>
댓글번호 : <%= comment.getComment().getCommentNo() %><br>
댓글작성자 : <%= comment.getComment().getUserId() %><br>
댓글작성일시 : <%= comment.getComment().getRegDate() %><br>
댓글내용 : <%= comment.getComment().getCommentContent() %><br>

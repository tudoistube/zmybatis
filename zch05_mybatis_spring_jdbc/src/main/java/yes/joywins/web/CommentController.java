...
import yes.joywins.service.IF_CommentJdbcService;
...
public class CommentController {
	...
	@Inject
	private IF_CommentJdbcService service;
	 ...
	 /*
	   ...
	   */
	   ...
	   /*
	    * ...주의사항 :
	    	 @RequestMapping 라고 해야 하는데 @ReqeustMapping 로 해놓고 구글링을 아무리 해도 답을
			 못찾을 수 있음.
	    */
	   @RequestMapping(value = "/selectComment", method = RequestMethod.GET)
	   ...
	   public void selectComments(Model model) throws Exception {
		...
		public void insertCommentGET(Model model) throws Exception {			
			logger.info("insertCommentGET called...........");
		}	   
		
	   
	    @RequestMapping(value = "/insertComment", method = RequestMethod.POST)
		public String insertCommentPOST(CommentVO comment, RedirectAttributes rattr) throws Exception {
			logger.info("insertCommentPOST  addFlashAttribute called...........");
			...
			return "redirect:/zcomment/selectComments";
		...
		public String deleteCommentPOST(@RequestParam("no") int no, 
							 RedirectAttributes rttr) throws Exception {

			logger.info("delete called... no = " + no);
			
			service.deleteComment(no);

			rttr.addFlashAttribute("msg", "SUCCESS");

			logger.info("삭제처리, bno = " + no);
